  ...
  <v-container>
    ...
    <v-row>
      <v-col cols="12" sm="6">
        ...
        <div class="d-flex">
          <dialog-time-picker
            :value="task.startTimePeriod"
            label="開始時間帯"
            :max="task.endTimePeriod"
            @input="task.startTimePeriod"
          />
          <dialog-time-picker
            :value="task.endTimePeriod"
            label="終了時間帯"
    ...
    <v-row>
      <v-col cols="12" sm="6">
        ...
        >
          <v-radio label="指定した単語のすべてが含まれる" value="and"></v-radio>
          <v-radio
      ...
      <template #expansion-content>
        <v-row>
          <v-col cols="12" sm="6">
            ...
            <input-text v-model="option.excludeKey" label="次の単語を除く" />
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" sm="6">
          ...
          <v-col cols="12" sm="6" md="6">
            ...
            <div class="d-flex flex-column">
              <input-text
                ...
                label="次のアカウントが送信"
              />
              <input-text v-model="option.toAccount" label="次のアカウント宛" />
              <input-text
        ...
        <v-row>
          ...
          <v-col cols="12" sm="6" md="4">
            <h5>フィルター</h5>
            <div v-for="filter in filterOptions" :key="filter" class="d-flex">
              <v-checkbox
